            ...
            <div className="incubator-bar p-3">
                <div className="row">
                    <div className="col-md-3">
                        <h3 className="m-0 pt-2"><strong>Mangoswap</strong></h3>
                    </div>
                    <div className="col-md-3">
                        <div className="d-flex justify-content-between">
                            ...
                            <div>
                                <p className="m-0"><small>50% complete</small></p>
                            </div>
                        </div>
                        <p className="m-0"><strong>$200,000/$400,000</strong></p>
                    </div>
                ...
                <div className="col-md-9">
                    <div className="incubator-container">
                        <div className="about-startup-container p-4">
                            <h4>About Startup</h4>
                            {
                                incubators.map(incubator => <p>{incubator.aboutStartupDescription}</p>)
                            }
                        </div>
                        <hr />
                        <div className="vision-container p-4">
                            <h4>Vision</h4>
                            {
                                incubators.map(incubator => <p>{incubator.visionDescription}</p>)
                            }
                        </div>
                    </div>
                </div>
